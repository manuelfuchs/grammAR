...
{
    public class MockCurseWordFilter : ICurseWordFilter
    {
        private IDictionary<Language, IEnumerable<string>> mockedCurseWords = InitKnownCurseWords();

        public MockCurseWordFilter()
        {
        ...
        private void ExtractCurseWords(IEnumerable<string> text)
        {
            ...
            var curseWords = mockedCurseWords[settingsComponent.Language];
